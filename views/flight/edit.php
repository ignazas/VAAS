...
<form id="flight-edit" class="form-horizontal" action="" method="POST" role="form">
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <select name="service_id" id="service_id" class="form-control"<?php if (!$this->HasPermission('Flight Manager')) echo ' disabled="disabled"'; ?>>
	<option value=""></option>
...
<?php } ?>
    ...
    <div class="form-group">
      ...
      <select name="payer" id="payer" class="form-control"<?php if (!$this->HasPermission('Flight Manager')) echo ' disabled="disabled"'; ?>>
	<option value=""></option>
...
<?php } ?>
    ...
    <div class="form-group">
      ...
      <select name="instructor" id="instructor" class="form-control"<?php if (!$this->HasPermission('Flight Manager')) echo ' disabled="disabled"'; ?>>
	<option value=""></option>
...
<?php } ?>
    ...
    <div class="form-group">
      ...
      <select name="airplane_id" id="airplane_id" class="form-control"<?php if (!$this->HasPermission('Flight Manager')) echo ' disabled="disabled"'; ?>>
	<option value=""></option>
...
<?php } ?>
    ...
    <div class="form-group"<?php if (!$this->HasPermission('Flight Manager')) echo ' disabled="disabled"'; ?>>
