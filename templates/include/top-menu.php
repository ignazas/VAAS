    ...
    <div class="navbar navbar-default navbar-static-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php?action="><i class="glyphicon glyphicon-dashboard"></i> VAAS</a>
        </div>
          ...
          <ul class="nav navbar-nav">
           ...
           <li <?php if ($action=="admin/news"||$action=="admin/bookings"||$action=="admin/finance") {echo "class=\"active\"";} ?> class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-cog"></i> Administravimas <b class="caret"></b></a>
           		<ul class="dropdown-menu">
                	...
                	<li <?php if ($action=="admin/aircrafts") {echo "class=\"active\"";} ?>><a class="" href="admin.php?action=aircraft"><i class="glyphicon glyphicon-plane"></i> Orlaiviai</a></li>
              	</ul>
           </li>
           <?php } ?>
